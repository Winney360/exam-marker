...
export default function Home() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-950">
        <div className="text-center max-w-md mx-auto px-6">
          ...
          <Link
            to="/dashboard"
            className="inline-flex items-center gap-2 px-6 py-3 bg-teal-400 text-slate-900 rounded-xl hover:bg-teal-300 transition-all font-medium shadow-lg shadow-teal-500/25"
          >
            Go to Dashboard
  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      <header className="sticky top-0 z-50 bg-slate-900/95 backdrop-blur-sm border-b border-slate-800/60">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 h-16 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-3">
            ...
            <Link
              to="/login"
              className="text-sm font-medium bg-teal-400 text-slate-900 px-5 py-2 rounded-xl hover:bg-teal-300 transition-all shadow-lg shadow-teal-500/25"
            >
              Get Started
            </Link>
          </nav>
      ...
      <main>
        {/* Hero */}
        <section className="relative pt-16 pb-32 min-h-[75vh] px-6 sm:px-8 overflow-hidden flex items-center">
          <div className="absolute inset-0">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-r from-slate-950/70 to-slate-950/70" />
          </div>
          <div className="relative max-w-3xl mx-auto text-center">
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                to="/login"
                className="inline-flex items-center gap-2 px-8 py-3.5 text-base font-medium bg-teal-400 text-slate-900 rounded-xl hover:bg-teal-300 transition-all shadow-xl shadow-teal-500/25 hover:shadow-teal-500/40"
              >
                Start grading free
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {features.map(({ Illustration, title, desc }) => (
                <div
                  key={title}
                  className="group relative bg-slate-900/40 backdrop-blur-md border border-slate-800/80 rounded-2xl p-8 hover:border-cyan-500/30 hover:shadow-xl hover:shadow-teal-500/5 transition-all duration-300"
                >
            ...
            <div className="relative grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              {steps.map((s) => (
                <div key={s.step} className="relative text-center">
                  <div className="relative z-10 w-14 h-14 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-teal-500/20"
                    style={{ background: 'linear-gradient(135deg, #06b6d4, #14b8a6)' }}>
